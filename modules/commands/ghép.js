...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        if(money < 100) api.sendMessage("Ghép đôi thất bại bạn không đủ 100 đô để chi trả",event.threadID,event.messageID)
        else {
