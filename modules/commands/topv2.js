module.exports.config = {
  ...
  version: "1.0.7",
  hasPermssion: 0,
  credits: "CatalizCS fix by manhIT",
...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
  ...
  if ((args[0] == "thread") || (args[0] == "-t")) {
  ...
  else if ((args[0] == "coins") || (args[0] == "-m")) {
    var data, msg = "", i = 0;

    //////////////////////////////////////////////
    //===== Lấy toàn bộ user và số coin =====//
    try {
      data = await Currencies.getAll(["userID", "coins"]);
    }
    catch (e) {
      console.log(e);
    }
    ...
    for (const dataUser of data) {
      ...
      msg += `${i + 1}/ ${name} với ${dataUser.coins} đô\n`;
      i += 1;
    }
